...
class Cafe {
  ...
  Cafe.full()
      : id = 99999,
        ...
        longitude = 0.0,
        cafeTypes = [
          CafeType.full(category: 'SPACE', type: 'WAREHOUSE', typeName: '창고형'),
          CafeType.full(category: 'SPACE', type: 'ROOFTOP', typeName: '루프탑'),
          CafeType.full(category: 'MOOD', type: 'MEET', typeName: '모임하기 좋은'),
          CafeType.full(category: 'CAFE', type: 'VIEW', typeName: '뷰 맛집'),
          CafeType.full(
              category: 'MOOD', type: 'PICTURE', typeName: '사진 찍기 좋은'),
          CafeType.full(category: 'SPACE', type: 'PLANT', typeName: '식물'),
        ],
